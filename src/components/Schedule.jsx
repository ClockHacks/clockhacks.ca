...
const nov5 = [
  {
    ...
    type: "game",
    description:
      "Ready to unwind after a night of coding? Come join us in a Discord channel to play Among Us.",
  },
  {
    ...
    time: "11:30 - 12:30",
    description:
      "Finding tech opportunities in high school can be one of the hardest parts of getting into university. In this workshop, we'll go over extracurriculars, grades, and how to prepare your resume for summer internships.",
  },
  {
    name: "Lunch Chat",
    time: "12:30 - 13:00",
    type: "activity",
    description:
      "Come talk to the organizers and other hackers while you eat lunch! Get together with your team in person and hop on a Discord call with us. Tell us what's going well, what you need help with, and what questions you might have.",
  },
  {
    ...
    type: "activity",
    description:
      "Watch the organizers of ClockHacks suffer by creating a hackathon project in just THREE HOURS! Link to the Twitch stream will be posted on Discord at the time of the event. This is just for fun and we will not be winning any of the prizes :)",
  },
  {
